...
import 'package:chatgpt/core/custom_exceptions.dart';
import 'package:chatgpt/features/global/provider.dart';
...
import 'package:chatgpt/utils/gpt_key.dart';
...
class TextCompletionRemoteDataSourceImpl
  ...
  Future<TextCompletionModel> getTextCompletion(String query) async {
    ...
    final response = await httpClient.post(
      ...
      body: encodedParams,
      headers: headerBearerOption(ApiKey.apiKey),
    );
